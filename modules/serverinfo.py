...
class ServerInfoMod(loader.Module):
    ...
    def get_os_info(self):
        if distro:
            ...
            try:
                ...
                os_info = f"Android {ver}" if ver else "Android (Termux)"
            except Exception:
    ...
    async def get_stats(self):
        ...
        try:
            ...
            s["ram_usage"] = f"{ram.used / 1024**3:.2f}/{ram.total / 1024**3:.2f} GB"
        except Exception:
            s["ram_usage"] = "N/A"
        ...
        try:
            ...
            s["disk_usage"] = self.strings("disk_template").format(
                used_disk=disk.used / 1024**3, free_disk=disk.free / 1024**3
            )
        except Exception:
            s["disk_usage"] = "N/A"
        ...
        try:
            ...
            s[
                "net_traffic"
            ] = f"↓ {net.bytes_recv / 1024**3:.2f} GB / ↑ {net.bytes_sent / 1024**3:.2f} GB"
        except (PermissionError, Exception):
            s["net_traffic"] = "N/A"
